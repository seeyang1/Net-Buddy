...
for i in newList:
    ...
    os.system("mysql --host=net-buddy.mysql.database.azure.com --user=nbseniordesign --password=\"j7Zp4wohzfR9n3\" -e \"use packet_sniffing; INSERT INTO nettraffic (Source,Destination,Protocol,Port,Count) VALUES (\'"+sqlLine+");\"")
f.close();
